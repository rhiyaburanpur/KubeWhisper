# Title: KUBEWHISPER: A MAPE-K Approach to Autonomic Container Orchestration using Large Language Models
...
**Solution:**
We propose **KUBEWHISPER**, an autonomic system that integrates the MAPE-K feedback loop with a Vector Space Model (VSM). This hybrid architecture automatically intercepts failure signals and retrieves context-aware solutions from technical documentation, effectively closing the loop between detection and diagnosis.
